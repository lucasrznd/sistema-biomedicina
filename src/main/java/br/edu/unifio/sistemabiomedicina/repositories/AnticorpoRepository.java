...
public class AnticorpoRepository {
    ...
    public  Anticorpo getById(Anticorpo anticorpo){return  em.find(Anticorpo.class, anticorpo.getId());}




    @Transactional
    public void inserir(Anticorpo anticorpo){em.persist(anticorpo);}
    ...
    @Transactional
    public void delete(Anticorpo anticorpo){em.remove(anticorpo.getId());}
